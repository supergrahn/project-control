...
export default function DonePage() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-text-primary text-base font-bold mb-5">✓ Done</h1>

      {tasks.length === 0 && (
        <div className="text-text-disabled text-sm text-center pt-10">No completed tasks yet</div>
      )}

      <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-3 opacity-75">
        {tasks.map(task => (
